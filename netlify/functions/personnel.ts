  ...
  try {
    switch (event.httpMethod) {
      ...
      case 'POST': {
        ...
        const { firstName, lastName, email, phone, position, department, salary, hireDate, status, userId } = payload || {};
      ...
      case 'DELETE': {
        ...
        return json(200, { message: 'Personnel deleted successfully' });
      }
      default:
        return json(405, { error: 'Method not allowed' });
    }
  } catch (error: any) {
    console.error('Personnel function error', error);
